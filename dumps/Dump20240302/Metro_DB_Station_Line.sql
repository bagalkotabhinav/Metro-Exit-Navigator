...
CREATE TABLE `Station_Line` (
  ...
  PRIMARY KEY (`SID`,`line`),
  CONSTRAINT `ST_ID` FOREIGN KEY (`SID`) REFERENCES `Stations` (`SID`)
...
INSERT INTO `Station_Line` VALUES (1,'Purple'),(2,'Green'),(2,'Purple'),(3,'Purple'),(4,'Green'),(5,'Green');
